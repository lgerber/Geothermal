...
p.test_name = 'frontend_dogger_hp_15';
p.max_evaluations =  110000;
p.nclusters =  1;
p.drawing.invert =  1;
p.keep_tails =  0;
p.keep_duplicates =  1;
