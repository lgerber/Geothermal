...
% o = osmose_appendModelMFileNames(o,{'dogger','heat_pump_2','heat_pump_1','demand_profiles','cridor','gas_boiler','wood_boiler'}); %,'refrigeration_cycle'
o = osmose_appendModelMFileNames(o,{'dogger','heat_pump_2','heat_pump_1','demand_profiles','cridor','gas_boiler','wood_boiler'});
% ------------------------------------------------------------------------
...
i=i+1; % 
o.Variables(i).ModelTagName = {'dogger'};
...
o.Moo.Latest = {'/home/lgerber/oc/CdF_dogger_optim/OSMOSE_results/run_0001/OSMOSE_moo/035001_evaluations'};
...
i = i+1;
o.Constants(i).ModelTagName    = {'dogger'};
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value = 3.3182282181292662e+00; % mai, juillet, août -> check!!!
p = p+1;
o.Constants(i).Period(p).Value = 3.3182282181292662e+00; % juin
p = p+1;
o.Constants(i).Period(p).Value = 3.3182282181292662e+00; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value = 3.3182282181292662e+00; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value = 3.3182282181292662e+00; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value = 3.3182282181292662e+00; % -10, dimensionnement
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value =  4.0636771003539565e+00; % mai, juillet, août -> check!!!
p = p+1;
o.Constants(i).Period(p).Value =  4.0636771003539565e+00; % juin
p = p+1;
o.Constants(i).Period(p).Value =  4.0636771003539565e+00; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value =  4.0636771003539565e+00; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value =  4.0636771003539565e+00; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value =  4.0636771003539565e+00; % -10, dimensionnement
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value =  1.8017597062334151e+01; % mai, juillet, août -> check!!!
p = p+1;
o.Constants(i).Period(p).Value =  2.0759052331943586e+01; % juin
p = p+1;
o.Constants(i).Period(p).Value =  2.4854329008920562e+01; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value =  1.5643938978464586e+01; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value =  1.6314793073620297e+01; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value =  3.2662615114056798e+01; % -10, dimensionnement
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value =  6.9137343377523365e+01; % mai, juillet, août -> check!!!
p = p+1;
o.Constants(i).Period(p).Value =  6.6911995316833043e+01; % juin
p = p+1;
o.Constants(i).Period(p).Value =  7.2617873177095291e+01; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value =  6.8895162790213334e+01; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value =  6.9099326628896861e+01; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value =  6.0234749424894531e+01; % -10, dimensionnement
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value =  1.0106528656903610e+01; % mai, juillet, août -> check!!!
p = p+1;
o.Constants(i).Period(p).Value =  6.1494058524312134e+00; % juin
p = p+1;
o.Constants(i).Period(p).Value =  1.2821901265773370e+01; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value =  1.0376018633304946e+01; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value =  9.8279010970568272e+00; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value =  1.5711338364350851e+01; % -10, dimensionnement
% =========================================================================
