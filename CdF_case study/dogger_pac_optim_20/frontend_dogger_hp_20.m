...
o.Paths.MooResultsDirectoryName = {'/home/lgerber/oc/CdF_dogger_optim_20/OSMOSE_results/run_0001'};
% 
% % ====================================================================================================
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value = 20; % mai, juillet, août -> check!!!
p = p+1;
o.Constants(i).Period(p).Value = 20; % juin
p = p+1;
o.Constants(i).Period(p).Value = 20; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value = 20; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value = 20; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value = 20; % -10, dimensionnement
