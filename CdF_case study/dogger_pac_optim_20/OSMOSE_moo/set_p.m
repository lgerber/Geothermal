...
p.test_name = 'frontend_dogger_hp_20';
p.max_evaluations =  35000;
p.nclusters =  1;
p.drawing.invert =  1;
p.keep_tails =  0;
p.keep_duplicates =  1;
...
p.shared_directory{1} = '/home/lgerber/oc/CdF_dogger_optim_20';
p.objective_directory = 'oc/Matlab_files/osmose_mine/handlers/computation/moo/';
p.test_directory = 'results/frontend_dogger_hp_20/';
p.run_number =  2;
p.run_directory = 'results/frontend_dogger_hp_20/run_0002/';
