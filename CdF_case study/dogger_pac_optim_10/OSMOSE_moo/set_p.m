...
p.test_name = 'frontend_dogger_hp_10';
...
p.shared_directory{1} = '/home/lgerber/oc/CdF_dogger_optim_10';
p.objective_directory = 'oc/Matlab_files/osmose_mine/handlers/computation/moo/';
p.test_directory = 'results/frontend_dogger_hp_10/';
p.run_number =  2;
p.run_directory = 'results/frontend_dogger_hp_10/run_0002/';
