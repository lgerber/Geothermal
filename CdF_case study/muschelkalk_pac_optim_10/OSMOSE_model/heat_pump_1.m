function technology = heat_pump_1
...
technology.PreModelMFunction                  = {'HP1_PreModel'};
  
%% User tagging definition
technology.TagName                    = {'heat_pump1'};     % User-defined tag name 
...
technology.Tags(nc).DefaultValue = 1.6e-8; % low range: 1.6e-8 (Bochatay, 2005) high-range: 2e-7 (Saner et al, 2010)
technology.Tags(nc).Unit = {'-'};
technology.Tags(nc).Status = {'CST'};
technology.Tags(nc).isVIT =3;
