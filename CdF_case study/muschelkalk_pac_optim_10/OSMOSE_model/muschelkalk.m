function technology = muschelkalk
...
technology.TagName                    = {'muschelkalk'};     % User-defined tag name 
technology.DisplayName                = {'geothermal resource, muschelkalk aquifer CdF'};     % User-defined pretty short name
technology.Description               = {'Model of the Muschelkalk aquifer of La Chaux-de-Fonds'};
...
technology.Tags(nc).DefaultValue = 20; % estimated by PDGN,2010 - values from 10-15
