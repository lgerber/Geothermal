function o = frontend_muschelkalk_cogen
% 
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value = 2.4452272310471248e+01; % mai, juillet, août -> check!!!
p = p+1;
o.Constants(i).Period(p).Value = 2.4452272310471248e+01; % juin
p = p+1;
o.Constants(i).Period(p).Value = 2.4452272310471248e+01; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value = 2.4452272310471248e+01; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value = 2.4452272310471248e+01; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value = 2.4452272310471248e+01; % -10, dimensionnement
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value = 4.0512474659813693e+03; % mai, juillet, août -> check!!!
p = p+1;
o.Constants(i).Period(p).Value = 0.0000000000000000e+00; % juin
p = p+1;
o.Constants(i).Period(p).Value = 3.5699486604682756e+03; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value = 2.0151306217811127e+03; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value = 1.0000000000000000e+03; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value = 3.5634211894875916e+03; % -10, dimensionnement
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value = 5.8984753886495760e+01; % mai, juillet, août -> check!!!
p = p+1;
o.Constants(i).Period(p).Value = 5.5640696441963719e+01; % juin
p = p+1;
o.Constants(i).Period(p).Value = 5.4052974361186550e+01; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value = 5.6815809827105603e+01; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value = 5.2430070936302648e+01; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value = 5.3934799821918446e+01; % -10, dimensionnement
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value = 6.4131856804685043e+01; % mai, juillet, août -> check!!!
p = p+1;
o.Constants(i).Period(p).Value = 6.7260196370180566e+01; % juin
p = p+1;
o.Constants(i).Period(p).Value = 7.5904685803578730e+01; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value = 6.7064692278110442e+01; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value = 6.5505161530839757e+01; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value = 6.1222350540889906e+01; % -10, dimensionnement
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value = 1.7707551864454324e+01; % mai, juillet, août -> check!!!
p = p+1;
o.Constants(i).Period(p).Value = 1.7707551864454324e+01; % juin
p = p+1;
o.Constants(i).Period(p).Value = 1.7707551864454324e+01; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value = 1.7707551864454324e+01; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value = 1.7707551864454324e+01; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value = 1.7707551864454324e+01; % -10, dimensionnement
...
o.Constants(i).Period(p).Value = 0; % juin
p = p+1;
o.Constants(i).Period(p).Value = 0; % avril, septembre
p = p+1;
o.Constants(i).Period(p).Value = 0; % mars, octobre
p = p+1;
o.Constants(i).Period(p).Value = 0; % novembre-février
p = p+1;
o.Constants(i).Period(p).Value = 0; % -10, dimensionnement
% =========================================================================
