function o = CdF_PostMultiPeriod_cogen_cad(o)
...
elec_sell_orc = osmose_getTag(o,'@elec_sell_orc','Period');
...
for i=1:p
    ...
    tot_elec_sell_orc = tot_elec_sell_orc + elec_sell_orc(i).Value;
end
...
tot_c_op_tot_elec = tot_ng_cost + tot_wood_cost + tot_geo_cost + tot_crid_op_cost - tot_elec_sell_cridor - tot_elec_sell_orc + op_sal;
...
turb_costs_usd = osmose_getMaximalValueforTag(o,'@turb_costs_usd');
pump_costs_usd = osmose_getMaximalValueforTag(o,'@pump_costs_usd');

turb_costs_chf = turb_costs_usd * conv_usd2chf;
pump_costs_chf = pump_costs_usd * conv_usd2chf;
...
cinv_tot_usd = drill_costs_usd + cost_pump_da_usd + pipe_dhn_cost_usd + turb_costs_usd + pump_costs_usd + hex_costs_usd;
...
if o.Silent == 0
    ...
    disp('')
    disp(['Total electricity selling ORC: ',num2str(tot_elec_sell_orc),'CHF'])
    disp('')
...
Tags(i).Value = tot_elec_sell_orc;
Tags(i).Units = {'CHF'};
...
i=i+1;
Tags(i).DisplayName = {'Turbine ORC cost USD'};
Tags(i).TagName = {'turb_costs_usd'};
Tags(i).Value = turb_costs_usd;
Tags(i).Units = {'USD'};

i=i+1;
Tags(i).DisplayName = {'Turbine ORC cost CHF'};
Tags(i).TagName = {'turb_costs_chf'};
Tags(i).Value = turb_costs_chf;
Tags(i).Units = {'CHF'};

i=i+1;
Tags(i).DisplayName = {'Pump ORC cost USD'};
Tags(i).TagName = {'pump_costs_usd'};
Tags(i).Value = pump_costs_usd;
Tags(i).Units = {'USD'};

i=i+1;
Tags(i).DisplayName = {'Pump ORC cost CHF'};
Tags(i).TagName = {'pump_costs_chf'};
Tags(i).Value = pump_costs_chf;
Tags(i).Units = {'CHF'};
