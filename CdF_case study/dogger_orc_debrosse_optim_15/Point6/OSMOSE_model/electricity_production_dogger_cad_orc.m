function technology = electricity_production_dogger_cad_orc
%% OSMOSE parameters
...
technology.Tags(nc).DefaultValue = 1; % 1 = used, 0 = not used
technology.Tags(nc).Unit = {'-'};
technology.Tags(nc).Status = {'CST'};
technology.Tags(nc).isVIT = 1;
...
technology.Tags(nc).DefaultValue = 20; % estimated by PDGN,2010
technology.Tags(nc).Unit = {'C'};
technology.Tags(nc).Status = {'CST'};
technology.Tags(nc).isVIT =1;
