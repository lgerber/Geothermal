...
o = osmose_appendModelMFileNames(o,{'electricity_production_dogger_wood_steam'}); %,'refrigeration_cycle'
% ------------------------------------------------------------------------
...
i=i+1; % 
o.Variables(i).ModelTagName = {'elec_prod'};
o.Variables(i).TagName = {'debrosse_p'};
o.Variables(i).Unit           = {'-'};
o.Variables(i).Is_integer     = 1;
o.Variables(i).Limits	  = [1 5];

i=i+1; % 
o.Variables(i).ModelTagName = {'elec_prod'};
o.Variables(i).TagName = {'s_1_frac1'};
o.Variables(i).Unit           = {'-'};
o.Variables(i).Is_integer     = 0;
o.Variables(i).Limits	  = [0.1 0.9];

i=i+1; % 
o.Variables(i).ModelTagName = {'elec_prod'};
o.Variables(i).TagName = {'s_2_frac1'};
o.Variables(i).Unit           = {'-'};
o.Variables(i).Is_integer     = 0;
o.Variables(i).Limits	  = [0.1 0.9];
...
i=i+1; % 
o.Variables(i).ModelTagName = {'elec_prod'};
o.Variables(i).TagName = {'rnk_3_t'};
o.Variables(i).Unit           = {'-'};
o.Variables(i).Is_integer     = 0;
o.Variables(i).Limits	  = [200 400];

i=i+1; % 
o.Variables(i).ModelTagName = {'elec_prod'};
o.Variables(i).TagName = {'dt_rnk_supheat'};
o.Variables(i).Unit           = {'-'};
o.Variables(i).Is_integer     = 0;
o.Variables(i).Limits	  = [10 100];

i=i+1; % 
o.Variables(i).ModelTagName = {'elec_prod'};
o.Variables(i).TagName = {'dt_rnk_resupheat1'};
o.Variables(i).Unit           = {'-'};
o.Variables(i).Is_integer     = 0;
o.Variables(i).Limits	  = [0 20];

i=i+1; % 
o.Variables(i).ModelTagName = {'elec_prod'};
o.Variables(i).TagName = {'dt_rnk_resupheat2'};
o.Variables(i).Unit           = {'-'};
o.Variables(i).Is_integer     = 0;
o.Variables(i).Limits	  = [0 20];
...
i=i+1; % 
o.Variables(i).ModelTagName = {'elec_prod'};
o.Variables(i).TagName = {'rnk_18_t'};
o.Variables(i).Unit           = {'-'};
o.Variables(i).Is_integer     = 0;
o.Variables(i).Limits	  = [60 80];

i=i+1; % 
o.Variables(i).ModelTagName = {'elec_prod'};
o.Variables(i).TagName = {'rnk_14_t'};
o.Variables(i).Unit           = {'-'};
o.Variables(i).Is_integer     = 0;
o.Variables(i).Limits	  = [80 100];
...
% o.Constants(i).Period(p).Value = 2250; % -10, dimensionnement
p = p+1;
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value = 1.4238196233497581e+01;
p = p+1;
o.Constants(i).Period(p).Value = 1.4238196233497581e+01; 
p = p+1;
o.Constants(i).Period(p).Value = 1.4238196233497581e+01; 
...
i = i+1;
o.Constants(i).ModelTagName    = {'elec_prod'};
o.Constants(i).TagName    = {'debrosse_p'};

p=0;
p = p+1;
o.Constants(i).Period(p).Value = 5;
p = p+1;
o.Constants(i).Period(p).Value = 5;
p = p+1;
o.Constants(i).Period(p).Value = 5;
...
i = i+1;
o.Constants(i).ModelTagName    = {'elec_prod'};
o.Constants(i).TagName    = {'s_1_frac1'};

p=0;
p = p+1;
o.Constants(i).Period(p).Value = 0.9;
p = p+1;
o.Constants(i).Period(p).Value = 0.9;
p = p+1;
o.Constants(i).Period(p).Value = 0.9;
...
i = i+1;
o.Constants(i).ModelTagName    = {'elec_prod'};
o.Constants(i).TagName    = {'s_2_frac1'};
...
i = i+1;
o.Constants(i).ModelTagName    = {'elec_prod'};
o.Constants(i).TagName    = {'rnk_3_t'};

p=0;
p = p+1;
o.Constants(i).Period(p).Value = 2.0249162015787326e+02;
p = p+1;
o.Constants(i).Period(p).Value = 2.0249162015787326e+02;
p = p+1;
o.Constants(i).Period(p).Value = 2.0249162015787326e+02;
...
p=0;
p = p+1;
o.Constants(i).Period(p).Value = 2.2992154652238375e+02;
p = p+1;
o.Constants(i).Period(p).Value =  2.2992154652238375e+02;
p = p+1;
o.Constants(i).Period(p).Value =  2.2992154652238375e+02;
...
i = i+1;
o.Constants(i).ModelTagName    = {'elec_prod'};
o.Constants(i).TagName    = {'dt_rnk_supheat'};

p=0;
p = p+1;
o.Constants(i).Period(p).Value = 9.7663156608896600e+01;
p = p+1;
o.Constants(i).Period(p).Value = 9.7663156608896600e+01;
p = p+1;
o.Constants(i).Period(p).Value = 9.7663156608896600e+01;
...
i = i+1;
o.Constants(i).ModelTagName    = {'elec_prod'};
o.Constants(i).TagName    = {'dt_rnk_resupheat1'};

p=0;
p = p+1;
o.Constants(i).Period(p).Value = 0.0000000000000000e+00;
p = p+1;
o.Constants(i).Period(p).Value = 0.0000000000000000e+00;
p = p+1;
o.Constants(i).Period(p).Value = 0.0000000000000000e+00;
...
i = i+1;
o.Constants(i).ModelTagName    = {'elec_prod'};
o.Constants(i).TagName    = {'dt_rnk_resupheat2'};

p=0;
p = p+1;
o.Constants(i).Period(p).Value = 5.7023552400141497e-01;
p = p+1;
o.Constants(i).Period(p).Value = 5.7023552400141497e-01;
p = p+1;
o.Constants(i).Period(p).Value = 5.7023552400141497e-01;
...
i = i+1;
o.Constants(i).ModelTagName    = {'elec_prod'};
o.Constants(i).TagName    = {'rnk_18_t'};

p=0;
p = p+1;
o.Constants(i).Period(p).Value = 6.7087366273277084e+01;
p = p+1;
o.Constants(i).Period(p).Value = 6.7087366273277084e+01;
p = p+1;
o.Constants(i).Period(p).Value = 6.7087366273277084e+01;
...
i = i+1;
o.Constants(i).ModelTagName    = {'elec_prod'};
o.Constants(i).TagName    = {'rnk_14_t'};

p=0;
p = p+1;
o.Constants(i).Period(p).Value = 80;
p = p+1;
o.Constants(i).Period(p).Value = 80;
p = p+1;
o.Constants(i).Period(p).Value = 80;
