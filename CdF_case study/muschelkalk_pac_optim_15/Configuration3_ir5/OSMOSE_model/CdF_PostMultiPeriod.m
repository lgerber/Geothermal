...
c_inv_nowell_usd = cinv_tot_usd - drill_costs_usd;
c_inv_nowell_chf = c_inv_nowell_usd * conv_usd2chf;

cinv_nowell_an_usd = cost_annualize(c, c_inv_nowell_usd);
cinv_nowell_an_chf = cost_annualize(c, c_inv_nowell_chf);

c.LifeTime = osmose_getTag(o,'@lifetime_well','Value');
cinv_well_chf = drill_costs_usd * conv_usd2chf;

cinv_well_an_usd = cost_annualize(c, drill_costs_usd);
cinv_well_an_chf = cost_annualize(c, cinv_well_chf);

cinv_an_usd = cinv_nowell_an_usd + cinv_well_an_usd;
cinv_an_chf = cinv_nowell_an_chf + cinv_well_an_chf;
